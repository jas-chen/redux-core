...
/***/ function(module, exports, __webpack_require__) {
	...
	var _rx = __webpack_require__(/*! rx */ 157);
	...
	var store = window.__state ? _reduxCore.createStore(_shared.reducer, window.__state) : _reduxCore.createStore(_shared.reducer);
	var intent$ = new _rx2['default'].Subject();
	
	var action$ = _shared.applyRxMiddleware(intent$, store);
	var state$ = action$.map(store.dispatch).startWith(store.getState());
	
	state$.subscribe(function (state) {
	  _react2['default'].render(_react2['default'].createElement(_sharedViewComponentsCounter2['default'], { state: state, intent$: intent$ }), root);
	}, function (err) {
	  throw new Error(err);
	}, function () {
	  return console.log('state$ completed.');
	});
...
/***/ function(module, exports, __webpack_require__) {
	...
	;(function (factory) {
	    ...
	    if (true) {
	        !(__WEBPACK_AMD_DEFINE_ARRAY__ = [__webpack_require__(/*! rx-lite */ 159)], __WEBPACK_AMD_DEFINE_RESULT__ = function (Rx, exports) {
	...
	/* WEBPACK VAR INJECTION */}.call(exports, __webpack_require__(/*! (webpack)/buildin/module.js */ 158)(module), (function() { return this; }())))
...
/***/ function(module, exports, __webpack_require__) {
	...
	/* WEBPACK VAR INJECTION */}.call(exports, __webpack_require__(/*! (webpack)/buildin/module.js */ 158)(module), (function() { return this; }()), __webpack_require__(/*! (webpack)/~/node-libs-browser/~/process/browser.js */ 3)))
...
/***/ function(module, exports, __webpack_require__) {
	...
	var _createStore = __webpack_require__(/*! ./createStore */ 161);
	
	var _createStore2 = _interopRequireDefault(_createStore);
	
	var _utilsCombineReducers = __webpack_require__(/*! ./utils/combineReducers */ 163);
...
/***/ function(module, exports, __webpack_require__) {
	...
	var _utilsIsPlainObject = __webpack_require__(/*! ./utils/isPlainObject */ 162);
...
/***/ function(module, exports, __webpack_require__) {
	...
	var _rxMiddlewareThunkMiddleware = __webpack_require__(/*! ./rx-middleware/thunkMiddleware */ 166);
	
	var _rxMiddlewareThunkMiddleware2 = _interopRequireDefault(_rxMiddlewareThunkMiddleware);
	
	var _rxMiddlewarePromiseMiddleware = __webpack_require__(/*! ./rx-middleware/promiseMiddleware */ 167);
	
	var _rxMiddlewarePromiseMiddleware2 = _interopRequireDefault(_rxMiddlewarePromiseMiddleware);
	
	var _rxMiddlewareDelayMiddleware = __webpack_require__(/*! ./rx-middleware/delayMiddleware */ 168);
